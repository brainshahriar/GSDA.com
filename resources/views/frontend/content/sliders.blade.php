      ...
      <ul>	<!-- SLIDE  -->
        ...
        data-description="Science says that Women are generally happier">
          ...
          <div class="tp-caption Newspaper-Subtitle   tp-resizeme"
            ...
            <form id="sform" action="/search"  class="cours-search">
              <div class="input-group">
                <input type="text" name="query" id="q" class="form-control typeahead" placeholder="What do you want to learn today?	">
